...
welcome(Req, State) ->
	...
	Models_Url = "http://contentapi.ws:5984/contentapi_text_maxcdn/_design/yb_entertainment_music/_view/short?descending=true&limit=10",
	...
	% All_Beauty_News_Url = "http://api.contentapi.ws/news?channel=entertainment_film&skip=0&limit=20",
	All_Beauty_News_Url = "http://contentapi.ws:5984/contentapi_text_maxcdn/_design/yb_entertainment_film/_view/by_id_title_desc_thumb_date?descending=true&limit=20",
	...
	{ok, Body} = morebeauty_dtl:render([{<<"videoParam">>,Params},{<<"Models">>,Models},{<<"allbeautynews">>,AllBeautyNews},{<<"latestPopularVideos">>,LatestPopularVideosParams}]),
    {Body, Req, State}.
