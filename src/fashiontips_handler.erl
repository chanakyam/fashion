...
welcome(Req, State) ->
	...
	Latest_Beauty_News_Url = "http://api.contentapi.ws/news?channel=beauty&skip=1&limit=4",
	...
	{ok, Body} = fashiontips_dtl:render([{<<"videoParam">>,Params},{<<"newsParam">>,ParamsNews},{<<"latestbeautynews1">>,LatestBeautyNews1},{<<"latestbeautynews">>,LatestBeautyNews},{<<"latestPopularVideos">>,LatestPopularVideosParams}]),
    {Body, Req2, State}.
